...
def sigterm_handler(signum, frame):
    checkpoints_tar(CHECKPOINTS_FILES_LIST, TAR_FILE)
    hpo_monitor_sigterm()
    sys.exit(3)
...
def plot_losses(losses_dict, epoch,trial):
    ...
    save_file_name = "./plots/loss_" +str(MODEL)+"_trial"+str(trial)+"_" + str(epoch)
...
"""
TODO: restart trial that was training when SIGTERM occured
"""
...
def main():
    ...
    try:
        ...
        #Pegasus work around always provide TAR
        CHECKPOINTS_FILES_LIST = extract_checkpoints(TAR_FILE, DIR)
